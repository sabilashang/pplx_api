 ...
 * API Route: /api/sonar
 * 
 * Handles requests to summarize text using the Perplexity Sonar model.
 * The Sonar model is a fast online model with web search capabilities.
 */
...
export async function POST(request: NextRequest) {
    try {
        ...
        console.error('Error in /api/sonar:', error)
