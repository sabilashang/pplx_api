...
/**
 * API Route: /api/sonar-pro
 * 
 * Handles requests to summarize text using the Perplexity Sonar Pro model.
 * The Sonar Pro model is an enhanced model with deeper reasoning capabilities.
 */
...
export async function POST(request: NextRequest) {
    try {
        ...
        console.error('Error in /api/sonar-pro:', error)
